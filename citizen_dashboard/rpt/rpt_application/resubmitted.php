...
<main class="max-w-6xl mx-auto px-4 py-8">
    ...
    <?php if ($total_applications === 0): ?>
        <div class="empty-state">
            ...
            <a href="need_correction.php" class="inline-flex items-center px-5 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    <div class="p-6 border-b border-gray-100 flex justify-between items-start">
                        ...
                        <div class="text-right">
                            ...
                            <div class="font-medium text-gray-900"><?php echo date('M j, Y', strtotime($app['resubmitted_date'])); ?></div>
                        </div>
                    </div>
