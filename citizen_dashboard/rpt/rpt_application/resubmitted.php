...
// Fetch user's resubmitted applications with all details like pending.php
$applications = [];
...
<title>Resubmitted Applications - RPT Services | GoServePH</title>
    ...
    <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="glass-header p-6 mb-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
                ...
                <div class="text-center">
                    <h1 class="text-2xl font-bold text-gray-900 mb-2">Resubmitted Applications</h1>
                    <p class="text-gray-600">Applications that have been corrected and resubmitted</p>
                </div>
                ...
                <div class="text-right">
                    ...
                    <div class="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-700 rounded-lg text-sm font-medium">
                        ...
                        <?php echo $total_applications; ?> Resubmitted
                    </div>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        <p class="text-sm text-blue-700">
                            Your corrected applications are back in the review queue. The assessment process restarts from the beginning. You'll receive email notifications at 
                            <span class="font-semibold"><?php echo $user_email; ?></span> 
        ...
        <?php if ($total_applications === 0): ?>
            ...
            <div class="form-card p-12 text-center">
                ...
                <p class="text-gray-600 mb-8 max-w-md mx-auto">You don't have any applications that have been resubmitted. Applications requiring corrections will appear here after you make the necessary changes.</p>
                <div class="space-x-4">
                    <a href="pending.php" 
                    ...
                    <a href="need_correction.php" 
                       class="inline-flex items-center px-6 py-3 bg-amber-500 text-white rounded-lg hover:bg-amber-600 font-medium transition-colors">
                        <i class="fas fa-edit mr-2"></i> Check Corrections
                    </a>
                </div>
            </div>
        <?php else: ?>
                        ...
                        <div class="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-indigo-50">
                            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                ...
                                <div class="text-gray-600 text-sm">
                                    ...
                                    Resubmitted: <?php echo date('F j, Y', strtotime($app['updated_at'])); ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
                                <div class="p-4 bg-blue-50 border border-blue-100 rounded-lg">
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-sm text-gray-700">
                                                Your corrected application is back in queue for initial review. The assessment process restarts from the beginning.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="p-4 bg-amber-50 border border-amber-100 rounded-lg">
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            <div class="text-sm font-semibold text-gray-900 mb-1">Estimated Timeline</div>
                                            <div class="text-sm text-gray-700">
                                                • Initial review: 3-5 days<br>
                                                • Property inspection: 5-7 days<br>
                                                • Assessment: 7-10 days<br>
