...
<title>Pending Applications - RPT Services | GoServePH</title>
        ...
        <div class="glass-header p-6 mb-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
                ...
                <div class="text-center">
                    <h1 class="text-2xl font-bold text-gray-900 mb-2">Pending Applications</h1>
                    <p class="text-gray-600">Applications currently under review</p>
                </div>
                ...
                <div class="text-right">
                    ...
                    <div class="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-700 rounded-lg text-sm font-medium">
                        ...
                        <?php echo $total_applications; ?> Pending
                    </div>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        <p class="text-sm text-blue-700">
                            Your applications are being reviewed. You'll receive email notifications at 
                                ...
                                <div class="p-4 bg-blue-50 border border-blue-100 rounded-lg">
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-sm text-gray-700">
                                                Your application is in queue for initial review. An assessor will be assigned within 5-7 working days. You'll receive email notifications for all updates.
                                            </div>
                                        </div>
                                    </div>
                                </div>
