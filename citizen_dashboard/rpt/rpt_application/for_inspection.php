                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="px-6 py-4 bg-blue-50">
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <div class="text-sm text-blue-700">Step 2 of 5</div>
                        </div>
                        <div class="progress-bar">
                            <div class="progress-fill" style="width: 40%"></div>
                        </div>
                        <div class="flex justify-between text-xs text-blue-600 mt-1">
                            <span><i class="fas fa-check-circle"></i> Submitted</span>
                            <span class="font-bold"><i class="fas fa-search"></i> Inspection</span>
