...
<main class="container mx-auto px-6 py-10 flex-grow max-w-6xl">
        ...
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-gray-600 text-lg">
                    Applications scheduled for property inspection
                </p>
            </div>
        </div>
    ...
    <?php if ($total_applications === 0): ?>
        ...
        <div class="lgu-card p-12 text-center">
            ...
            <h3 class="text-lg font-medium text-gray-900 mb-2">No Inspection Scheduled</h3>
            ...
            <div class="space-x-4">
                ...
                <a href="assessed.php" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm transition-colors">
                    <i class="fas fa-chart-bar mr-2"></i>Assessed Applications
                </a>
            </div>
        </div>
    <?php else: ?>
                ...
                <div class="lgu-card overflow-hidden">
                    ...
                    <div class="p-6 border-b border-gray-100">
                        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div>
                                <div class="flex items-center gap-3 mb-2">
                                    ...
                                    <span class="status-badge status-inspection">
                                        <i class="fas fa-search mr-1"></i>For Inspection
                                    </span>
                                </div>
                            ...
                            <div class="text-gray-600 text-sm">
                                Submitted: <?php echo date('M j, Y', strtotime($app['application_date'])); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php if (!empty($app['scheduled_date'])): ?>
                        <div class="inspection-box mx-6 mt-4">
                            <div class="flex items-center justify-between mb-3">
                                <div class="font-medium text-blue-800 flex items-center">
                                    <i class="fas fa-calendar-alt mr-2"></i>Inspection Scheduled
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <div class="text-xs text-gray-600 mb-1">Scheduled Date</div>
                                    <div class="text-sm font-medium text-gray-900"><?php echo date('F j, Y', strtotime($app['scheduled_date'])); ?></div>
                                </div>
                                <div>
                                    <div class="text-xs text-gray-600 mb-1">Assigned Assessor</div>
                                    <div class="text-sm font-medium text-gray-900"><?php echo htmlspecialchars($app['assessor_name']); ?></div>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="p-6 bg-gray-50 border-b border-gray-100">
                        <div class="mb-2 text-sm text-gray-700">
                            Application Progress: <span class="font-medium">Step 2 of 4</span>
                        </div>
                        <div class="simple-progress mb-2">
                            <div class="simple-progress-fill" style="width: 50%"></div>
                        </div>
        ...
        <div class="mt-8 lgu-card p-6">
            <h3 class="font-medium text-gray-900 mb-3">About Property Inspection</h3>
            <div class="space-y-2 text-sm text-gray-600">
                <div class="flex items-start">
                    <i class="fas fa-calendar-check text-blue-500 mt-1 mr-2"></i>
                    <span>An assessor will visit your property on the scheduled date</span>
                </div>
                <div class="flex items-start">
                    <i class="fas fa-user-tie text-blue-500 mt-1 mr-2"></i>
                    <span>Make sure someone is present to grant access to the assessor</span>
                </div>
                <div class="flex items-start">
                    <i class="fas fa-file-alt text-blue-500 mt-1 mr-2"></i>
                    <span>Prepare the original documents for verification</span>
                </div>
                <div class="flex items-start">
                    <i class="fas fa-clock text-blue-500 mt-1 mr-2"></i>
                    <span>Inspection typically takes 1-2 hours depending on property size</span>
                </div>
            </div>
        </div>
    <?php endif; ?>
