...
<title>Assessed Applications - RPT Services | GoServePH</title>
    ...
    <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="glass-header p-6 mb-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
                ...
                <div class="text-center">
                    <h1 class="text-2xl font-bold text-gray-900 mb-2">Assessed Applications</h1>
                    <p class="text-gray-600">Applications that have been inspected and are being assessed</p>
                </div>
                ...
                <div class="text-right">
                    ...
                    <div class="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-700 rounded-lg text-sm font-medium">
                        ...
                        <?php echo $total_applications; ?> Under Assessment
                    </div>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        <p class="text-sm text-blue-700">
                            Your applications have been inspected and are now being assessed for tax valuation. This process typically takes 3-5 business days. You'll receive email notifications at 
        ...
        <?php if ($total_applications === 0): ?>
            ...
            <div class="form-card p-12 text-center">
                ...
                <h3 class="text-xl font-semibold text-gray-900 mb-2">No Applications Under Assessment</h3>
                <p class="text-gray-600 mb-8 max-w-md mx-auto">You don't have any applications currently being assessed. Check your applications for inspection status.</p>
                <div class="space-x-4">
                    <a href="for_inspection.php" 
                       class="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium transition-colors">
                        <i class="fas fa-search mr-2"></i> View For Inspection
                    </a>
                    <a href="pending.php" 
            ...
            <div class="space-y-8">
                <?php foreach ($applications as $app): ?>
                    ...
                    <div class="form-card overflow-hidden">
                                ...
                                <div>
                                    <div class="flex items-center gap-3 mb-2">
                                        ...
                                        <span class="status-badge status-assessed">
                                            <i class="fas fa-chart-line"></i> Under Assessment
                                        </span>
                                    </div>
                        ...
                        <div class="assessment-highlight mx-6 mt-6">
                            <div class="flex items-center justify-between mb-4">
                                <div class="font-semibold text-amber-800 flex items-center text-lg">
                                    <i class="fas fa-spinner fa-spin mr-3"></i>Assessment In Progress
                                </div>
                                <div class="text-amber-700 font-bold">
                                    <i class="fas fa-clock mr-2"></i>3-5 business days
                                </div>
                            </div>
                            <div class="text-sm text-gray-700">
                                Your property has been inspected and is now being assessed for tax valuation. Our assessors are analyzing the property details and market values.
                            </div>
                        </div>
                        ...
                        <div class="px-6 py-4 bg-gray-50 border-b border-gray-100">
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <div class="text-sm font-semibold text-blue-600">Step 3 of 4</div>
                            </div>
                            ...
                            <div class="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
                                <div class="p-4 bg-blue-50 border border-blue-100 rounded-lg">
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-sm text-gray-700">
                                                Your property assessment is in progress. Once completed, you'll receive the tax declaration and payment details. Assessment typically takes 3-5 business days.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="p-4 bg-amber-50 border border-amber-100 rounded-lg">
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            <div class="text-sm font-semibold text-gray-900 mb-1">Assessment Factors</div>
                                            <div class="text-sm text-gray-700">
                                                • Property location and size<br>
                                                • Building improvements (if any)<br>
