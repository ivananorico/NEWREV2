...
<title>Applications Needing Correction - Market Rent Services</title>
...
<main class="max-w-6xl mx-auto px-4 py-6">
    ...
    <div class="mb-6">
        <div class="bg-white rounded border border-gray-200 p-4">
            <div class="flex items-center mb-3">
                ...
                <div>
                    <h1 class="text-xl font-bold text-gray-900">Applications Needing Correction</h1>
                    <p class="text-gray-600 text-sm">Applications that require corrections before proceeding</p>
                </div>
            </div>
            ...
            <?php if ($total_applications > 0): ?>
                <div class="flex items-center mt-3">
                    ...
                    <div class="ml-3">
                        <div class="status-badge status-correction">
    ...
    <?php if ($total_applications === 0): ?>
        ...
        <div class="bg-white rounded border border-gray-200 p-6 text-center">
            ...
            <h3 class="text-lg font-semibold text-gray-800 mb-2">No Corrections Needed</h3>
            <p class="text-gray-600 mb-4">All your applications are in good standing.</p>
        ...
        <div class="space-y-4">
            <?php foreach ($applications as $app): ?>
                <?php
                    ...
                    // Format updated date
                    $updated_date = !empty($app['updated_at']) ? date('M j, Y', strtotime($app['updated_at'])) : date('M j, Y', strtotime($app['created_at']));
                ?>
                ...
                <div class="card urgent-alert">
                    ...
                    <div class="px-4 py-3 bg-red-50 border-y border-red-200">
                        <div class="flex items-start">
                            <i class="fas fa-comment-dots text-red-500 mt-1 mr-2 text-sm"></i>
                            <div>
                                <h4 class="font-semibold text-red-800 text-sm mb-1">Admin's Correction Notes:</h4>
                                <p class="text-red-700 text-xs"><?php echo htmlspecialchars($app['correction_notes']); ?></p>
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="px-4 py-3 bg-gray-50 border-b border-gray-100">
                        <div class="mb-1">
                            ...
                            <div class="h-1.5 bg-gray-200 rounded-full overflow-hidden">
                                <div class="h-full bg-red-500" style="width: 12.5%"></div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="space-y-4">
                                                ...
                                                <div class="pt-2 mt-2 border-t border-purple-200">
                                                    <div class="flex justify-between items-center">
                                                        <div>
                                                            ...
                                                            <div class="text-xs text-gray-600">Payable after corrections approved</div>
                                                        </div>
                                        ...
                                        <div class="p-3 bg-red-50 rounded border border-red-100">
                                            <h4 class="font-medium text-gray-800 mb-1">Correction Required</h4>
                                            <div class="flex items-center">
                                                <div class="status-badge status-correction mr-2">
                                                    <i class="fas fa-exclamation-triangle mr-1"></i>Needs Correction
                                                </div>
                                                <div class="text-xs text-red-700">
                                                    Fix issues and resubmit to continue
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="p-3 bg-red-50 border-t border-red-100">
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between">
                            <div class="mb-2 sm:mb-0">
                                ...
                                <div class="text-gray-600 text-sm">
                                    Please make the necessary corrections and resubmit your application to proceed with the interview process.
                                </div>
                            </div>
                            <a href="edit_correction.php?id=<?php echo $app['id']; ?>" 
                               class="inline-flex items-center px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 text-sm font-medium transition">
