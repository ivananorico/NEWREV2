...
<head>
    ...
    <style>
        ...
        .progress-fill {
            height: 100%;
            border-radius: 4px;
            background: linear-gradient(90deg, #f59e0b 0%, #f59e0b 8.33%, #e5e7eb 8.33%, #e5e7eb 100%);
        }
...
<main class="container mx-auto px-4 sm:px-6 py-8 max-w-6xl flex-grow">
        ...
        <div class="flex items-center justify-between mb-4">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-gray-600">Applications under review - Initial processing</p>
                </div>
            </div>
            <?php if ($total_applications > 0): ?>
            <div class="text-right">
                <div class="text-sm text-gray-500">Applications Waiting</div>
                <div class="text-2xl font-bold text-orange-600"><?php echo $total_applications; ?></div>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="mt-6">
            <div class="progress-steps">
                <div class="progress-step">
                    ...
                    <div class="step-label active">Pending</div>
                </div>
                ...
                <div class="progress-step">
                    ...
                    <div class="step-label">Sched Interview</div>
                </div>
            ...
            <div class="flex items-center justify-between text-sm text-gray-600 mt-4">
                <span>Current Status: <span class="font-bold text-orange-600">Pending Review</span></span>
    ...
    <?php if ($total_applications === 0): ?>
        ...
        <div class="form-card p-12 text-center">
            ...
            <h3 class="text-xl font-semibold text-gray-900 mb-3">No Pending Applications</h3>
            <p class="text-gray-600 mb-8 max-w-md mx-auto">
                You don't have any applications waiting for initial review. Start a new application to rent a market stall.
            </p>
            <a href="../market_portal_services/market_portal_services.php" 
               class="inline-flex items-center px-5 py-2.5 bg-[var(--primary)] text-white rounded-lg hover:opacity-90 transition-colors">
                <i class="fas fa-store mr-2"></i>Apply for a Market Stall
            </a>
        </div>
    <?php else: ?>
        <div class="space-y-8">
            <?php foreach ($applications as $app): ?>
                <?php
                    ...
                    // Get business name and type from rent_stall table
                    ...
                    <div class="p-6 border-b border-gray-200">
                        <div class="flex flex-col md:flex-row md:items-center justify-between mb-4">
                            ...
                            <div class="mt-3 md:mt-0">
                                <div class="text-sm text-gray-500">Date Applied</div>
                                <div class="font-medium text-gray-900"><?php echo $app_date; ?></div>
                            </div>
                        </div>
                        
                        <!-- REMOVED: Application Progress for each card (redundant) -->
                    </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-700 mb-2">
                                    Your application is currently on <span class="font-bold text-orange-600">Step 1: Pending Review</span>. 
                                    The market office is conducting initial review of your application.
                                </p>
                                <ul class="text-sm text-gray-700 space-y-1">
                                    <li class="flex items-start">
                                        <i class="fas fa-clock text-orange-500 mr-2 mt-0.5"></i>
                                        <span><strong>Step 1 (Current):</strong> Application under initial review (submitted on <?php echo $app_date; ?>)</span>
                                    </li>
                                    <li class="flex items-start">
                                        <i class="fas fa-arrow-right text-gray-400 mr-2 mt-0.5"></i>
                                        <span><strong>Step 2:</strong> Schedule interview (if application passes initial review)</span>
                                    </li>
                                    <li class="flex items-start">
                                        <i class="fas fa-arrow-right text-gray-400 mr-2 mt-0.5"></i>
