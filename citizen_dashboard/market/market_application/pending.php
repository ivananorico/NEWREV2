...
// Fetch user's pending applications with all renter info and rental registration info
$applications = [];
...
<main class="max-w-6xl mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        <div class="bg-white shadow-md rounded-xl p-6 border border-gray-200">
            <div class="flex items-center mb-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Pending Market Applications</h1>
                    <p class="text-gray-600 mt-1">Your stall rental applications are waiting for interview</p>
                </div>
            </div>
            ...
            <?php if ($total_applications > 0): ?>
                <div class="mt-4 flex items-center">
                    ...
                    <div class="ml-4">
                        <div class="status-badge status-pending"><i class="fas fa-clock mr-2"></i>Pending Interview</div>
                    </div>
                </div>
            <?php endif; ?>
        </div>
    ...
    <?php if ($total_applications === 0): ?>
        <div class="empty-state">
            ...
            <p class="text-gray-600 mb-6">You don't have any market stall applications pending interview.</p>
                    ...
                    <div class="p-6 border-b border-gray-100 flex justify-between items-start">
                        <div>
                            <div class="flex items-center mb-3">
                                ...
                                <span class="status-badge status-pending"><i class="fas fa-clock mr-1"></i>Pending Interview</span>
                            </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <div class="text-sm text-gray-600">
                                    Waiting for interview schedule. You will be contacted via email or SMS for your interview date and time.
                                </div>
                            </div>
                            <div class="text-sm text-yellow-700">
                                <i class="fas fa-info-circle mr-1"></i>
                                Please prepare original documents for verification
                            </div>
                        </div>
                    </div>
                </div>
