...
<main class="max-w-6xl mx-auto px-4 py-6">
    ...
    <div class="mb-6">
        <div class="bg-white rounded border border-gray-200 p-4">
            <div class="flex items-center mb-3">
                ...
                <div>
                    <h1 class="text-xl font-bold text-gray-900">Resubmitted Applications</h1>
                    <p class="text-gray-600 text-sm">Applications corrected and waiting for review</p>
                </div>
            </div>
    ...
    <?php if ($total_applications === 0): ?>
        ...
        <div class="bg-white rounded border border-gray-200 p-6 text-center">
            ...
            <h3 class="text-lg font-semibold text-gray-800 mb-2">No Resubmitted Applications</h3>
            <p class="text-gray-600 mb-4">You don't have any applications in resubmitted status.</p>
                    ...
                    <div class="p-4 border-b border-gray-100">
                        <div class="flex justify-between items-start">
                            ...
                            <div class="text-right">
                                <div class="text-xs text-gray-500">Resubmitted</div>
                                        ...
                                        <div>
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="info-value"><?php echo date('F j, Y g:i A', strtotime($app['updated_at'])); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="p-3 bg-blue-50 rounded border border-blue-100">
                                            ...
                                            <div class="flex items-center">
                                                <div class="status-badge status-resubmitted mr-2">
                                                    <i class="fas fa-sync-alt mr-1"></i>Resubmitted
                                                </div>
                                                <div class="text-xs text-blue-700">
                                                    Corrections completed. Waiting for review.
                                                </div>
                                            </div>
                                            <div class="mt-2 p-2 bg-green-50 rounded border border-green-100">
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="text-xs text-green-700">
                                                        Corrections made on <?php echo date('F j, Y', strtotime($app['updated_at'])); ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="p-3 bg-blue-50 border-t border-blue-100">
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between">
                            <div class="mb-2 sm:mb-0">
                                ...
                                <div class="text-gray-600 text-sm">
                                    Your corrected application is now under review. You will be contacted via email or SMS for interview scheduling.
                                </div>
                            </div>
