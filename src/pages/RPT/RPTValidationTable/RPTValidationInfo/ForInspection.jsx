    ...
    return (
        <div className="min-h-screen bg-gray-50 py-6">
            <div className="max-w-7xl mx-auto px-4">
                ...
                {/* Inspection Details Card - Using backend field names */}
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="w-full lg:w-80 flex flex-col gap-4 p-6 bg-blue-50 rounded-xl shadow-lg border border-blue-100">
                        ...
                        {/* ACTION 1: Mark as Assessed Button */}
                        <button
                        ...
                        <div className="mt-6 pt-4 border-t border-blue-200">
                            ...
                            <div className="space-y-3">
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-xs font-medium text-blue-700 bg-blue-100 px-2 py-1 rounded">For Inspection</span>
                                </div>
                                <div className="flex justify-between items-center">
                                ...
                                {registration.inspection_date && (
                                    <div className="flex justify-between items-center">
                                        <span className="text-xs text-gray-600 min-w-[80px]">Inspection</span>
                                        <span className="text-xs text-gray-700">{formatDate(registration.inspection_date, 'MMM d, yyyy')}</span>
                                    </div>
                                )}
                                <div className="flex justify-between items-center">
                        ...
                        <div className="bg-gray-50 p-5 rounded-lg space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-900 font-medium text-sm">{registration.sex}</p>
                                </div>
                                <div>
                                    <label className="block text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Marital Status</label>
                                    <p className="text-gray-900 font-medium text-sm">{registration.marital_status}</p>
                                </div>
                                <div>
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <textarea 
                                            ...
                                            placeholder="Explain why this application needs correction..." 
                                            required 
                                        />
                                    </div>
                                    ...
                                    <p className="text-sm text-red-600">
                                        This will change status to "needs_correction" and notify the property owner.
                                    </p>
                                </div>
                            </div>
                        </div>
