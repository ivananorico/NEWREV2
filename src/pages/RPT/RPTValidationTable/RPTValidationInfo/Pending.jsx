        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-white/30 p-6 mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900">Pending Application Review</h1>
              <p className="text-gray-600 mt-2">Reference: <span className="font-semibold text-blue-700">{registration.reference_number}</span></p>
            </div>
            <span className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white px-4 py-2 rounded-full font-semibold shadow-lg flex items-center">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-8">
            ...
            <div className="relative">
              <div className="w-full h-3 bg-gray-200 rounded-full overflow-hidden shadow-inner">
                <div className="h-3 bg-gradient-to-r from-yellow-400 to-orange-400 rounded-full transition-all duration-500" style={{ width: '25%' }}></div>
              </div>
              <div className="flex justify-between mt-2">
                {[1, 2, 3, 4].map((step) => (
                  <div key={step} className={`w-8 h-8 rounded-full flex items-center justify-center ${step === 1 ? 'bg-yellow-500 text-white shadow-lg' : 'bg-gray-300 text-gray-600'}`}>
                    {step}
                  </div>
                ))}
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-blue-200">
                ...
                <div className="space-y-3 bg-white/50 p-4 rounded-lg">
                  {[
                    ...
                    { label: 'Status', value: 'Pending Review', color: 'text-yellow-700' },
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-amber-50 rounded-2xl shadow-lg p-6 border border-yellow-100">
              ...
              <div className="space-y-3">
                <div className="bg-white/70 p-4 rounded-lg">
                  ...
                  <div className="font-semibold text-yellow-700">Initial Review by Assessor</div>
                </div>
                
                <div className="text-sm text-gray-600">
                  <p className="mb-2">Estimated Timeline:</p>
                  <ul className="space-y-1">
                    <li className="flex items-center">
                      <div className="w-2 h-2 bg-yellow-500 rounded-full mr-2"></div>
                      <span>Initial review: 1-2 days</span>
                    </li>
                    <li className="flex items-center">
                      <div className="w-2 h-2 bg-blue-400 rounded-full mr-2"></div>
                      <span>Property inspection: 3-5 days</span>
                    </li>
                    <li className="flex items-center">
                      <div className="w-2 h-2 bg-green-400 rounded-full mr-2"></div>
                      <span>Assessment: 2-3 days</span>
                    </li>
                  </ul>
                </div>
              </div>
