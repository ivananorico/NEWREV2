      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full font-semibold">RESUBMITTED</span>
          </div>
          ...
          {correctionNotes && (
            <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold text-yellow-800 mb-1">Previous Correction Notes</h3>
                  <p className="text-yellow-700 whitespace-pre-line">{correctionNotes}</p>
                  <div className="text-xs text-yellow-600 mt-2">
                    Originally submitted on: {formatDate(registration.created_at, 'MMM d, yyyy • h:mm a')}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 pt-4 border-t border-blue-200">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xs font-medium text-blue-700 bg-blue-100 px-2 py-1 rounded">Resubmitted</span>
                </div>
                <div className="flex justify-between items-center">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-xs text-gray-600 min-w-[80px]">Resubmitted</span>
                  <span className="text-xs text-gray-700">{formatDate(registration.updated_at || registration.date_registered, 'MMM d, yyyy • h:mm a')}</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-xl shadow-2xl max-w-md w-full">
              <div className="p-6">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <button onClick={() => setShowInspectionForm(false)} className="text-gray-400 hover:text-gray-600">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                    </svg>
                  </button>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3 pt-4">
                    <button 
                      ...
                      disabled={loading}
                      className="flex-1 bg-green-600 hover:bg-green-700 disabled:bg-green-400 text-white py-2 rounded flex items-center justify-center"
                    >
                      {loading ? (
                        <>
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-red-600">
                    This will change status to "needs_correction" and notify the citizen.
                  </p>
                </div>
              </div>
            </div>
